    ...
    <div className="space-y-5">
      <SettingsRow label="Default persona" desc="Persona for New Chats.">
        <select
          ...
          className="w-full sm:w-48 rounded-md border border-gray-300 dark:border-[#3a3a3d] bg-white dark:bg-[#2c2c2f] text-[#1a1a1a] dark:text-[#f2f2f0] px-3 py-1.5 text-sm outline-none capitalize"
        >
          {PERSONAS.map((p) => (
