...
export default function ChatBody({
  ...
  const botBubbleClass =
    "translate-y-4 px-6 py-4 rounded-r-[35px] font-extralight rounded-bl-[25px] text-[15px] leading-relaxed max-w-[56ch] bg-[#e7e5e0] text-[#2a2a28] whitespace-pre-wrap break-words";
  ...
  return (
    <div className="flex-1 overflow-y-auto px-10 pt-24 pb-9 flex flex-col bg-[#202023] chat-scrollbar">
